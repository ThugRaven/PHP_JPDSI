...
require_once $conf->root_path . '/app/calc_cred/CalcCredForm.class.php';
require_once $conf->root_path . '/app/calc_cred/CalcCredResult.class.php';
...
//        $smarty->assign('role', $role);
        ...
        $smarty->display($conf->root_path . '/app/calc_cred/CalcCredView.tpl');
    }
