...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{$conf->app_url}/app/css/style.css"/>
                ...
                <nav id="nav">
                    <ul>
                        <li><a href="{$conf->app_url}/index.php">Strona główna</a></li>
                            {if !empty($role)}
                            <li>Zalogowano jako {$role}</li>
                            <li><a href="{$conf->app_url}/app/security/logout.php" class="button primary">Wyloguj się</a></li>
                            {else}
